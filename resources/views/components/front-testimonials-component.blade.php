                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{ asset('assets-front') }}/images/c1.jpg"
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{ asset('assets-front') }}/images/c2.jpg"
                                            class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Shveta</h3>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{ asset('assets-front') }}/images/c3.jpg"
                                            class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Roy Linderson</h3>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{ asset('assets-front') }}/images/c4.jpg"
                                            class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Mike Thyson</h3>
