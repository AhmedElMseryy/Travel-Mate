<section class="w3l-main-slider" id="home">
    <div class="banner-content">
        <div id="demo-1"
            data-zs-src='["{{ asset('assets-front') }}/images/banner1.jpg", "{{ asset('assets-front') }}/images/banner2.jpg","{{ asset('assets-front') }}/images/banner3.jpg", "{{ asset('assets-front') }}/images/banner4.jpg"]'
